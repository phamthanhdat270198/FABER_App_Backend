...
def add_is_active_column():
    ...
    try:
        ...
        if 'is_active' not in column_names:
            ...
            cursor.execute("ALTER TABLE type_details ADD COLUMN is_active BOOLEAN NOT NULL DEFAULT 1")
            conn.commit()
            print("Đã thêm cột is_active vào bảng type_details thành công!")
        else:
            print("Cột is_active đã tồn tại trong bảng type_details.")
